...
import com.texasholdem.security.login.enums.Active;
import com.texasholdem.security.login.service.LoginService;
import com.texasholdem.security.shiro.filter.LoginListener;
...
//    @Transactional
    public RestResponse login(String username, String password) {
        ...
        try {
//            if (hard) {
//                response = loginService.login(username, password, ip, gAuthCode, loginChecker);
//            }
