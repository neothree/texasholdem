...
public class PlayerSessionTest {
    ...
    public static void setUp() {
        ...
        gameRoomList = new ArrayList<>(NUM_OF_GAME_ROOMS);
        sessionList = new ArrayList<>(NUM_OF_GAME_ROOMS * SESSIONS_PER_GAME_ROOM);
        for (int i = 1; i <= NUM_OF_GAME_ROOMS; i++) {
            ...
            sessionBuilder.parentGame(game).gameRoomName("Zombie_ROOM_" + i).protocol(DUMMY_PROTOCOL);
