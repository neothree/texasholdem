package com.texasthree.core.app;
...
public interface GameRoom {
     ...
     *
     * @param playerSession The incoming user session. If we are using netty, it would be
     ...
     *
     * @param session The session to be removed from the set.
     ...
     *
     * @param parentGame The game to which this game room belongs.
     */
     ...
     * appropriate filter chains to the session.
     *
     * @param protocol The protocol instance to set.
     */
     ...
     * {@link Session#onEvent(com.texasthree.core.event.Event)} of the
     ...
     *
     * @param networkEvent The message that is to be broadcast to all user sessions of
     *                     this game room
     */
