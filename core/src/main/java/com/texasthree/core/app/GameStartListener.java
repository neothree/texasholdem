...
public interface GameStartListener {
     ...
     *
     * @param isInitialized If this is a persisted instance, then restarts would be called
     *                      with isInitialized set to true. TODO current version does not
     *                      support persistence and hence this parameter will always be
     *                      false.
     * @param properties    The environment properties which would be a combination of JVM
    ...
    /**
     * @param gameRoom The game room instance to set on the implementation.
     */
