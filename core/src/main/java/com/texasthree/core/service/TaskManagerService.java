...
public interface TaskManagerService {
     ...
     *
     * @param task         The task to be scheduled.
     * @param initialDelay Initial delay before the task is first done.
     * @param period       Fixed period of execution.
     * @param unit         seconds, milliseconds etc for delay.
     * @return A scheduled future, which is a handle to the task and can be used
     * to cancel it, get completed status etc.
     */
     ...
     * @param task         The task to be scheduled.
     * @param initialDelay Initial delay before the task is first done.
     * @param delay        The delay between each subsequent execution
     * @param unit         seconds, milliseconds etc for delay.
     * @return A scheduled future, which is a handle to the task and can be used
     * to cancel it, get completed status etc.
     */
