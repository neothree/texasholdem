...
public interface GameStateManagerService {
     ...
     *
     * @param key The current state is wrapped in this object key.
     ...
     *
     * @param syncKey Sync key of the incoming object
     ...
     *
     * @param serializedBytes the serialized AMF3 or other object in byte array format.
     */
