...
public interface GameAdminService {
     ...
     *
     * @param game The game instance to register with the admin service.
     ...
     *
     * @param gameId   The unique number identifier for the game. Most probably a
     *                 database key.
     * @param gameName The unique name for a game.
     ...
     *
     * @param game The instance of the game to unload.
     * @return Optionally returns an object, if it is an asynchronous operation,
     * then it would return a Future object, otherwise it would return a
     * boolean suggesting success(true) or failure(false).
     */
     ...
     *
     * @param game         The game for which the game room need to be loaded.
     * @param gameRoomId   The unique identifier for the game room. Most probably a
     *                     database id.
     * @param gameRoomName The name of the game room to load.
     * @return Optionally returns an object, if it is an asynchronous operation,
     * then it would return a Future object, otherwise it would return a
     * boolean suggesting success(true) or failure(false).
     */
     ...
     *
     * @param gameRoom The game room instance which is to be unloaded.
     */
     ...
     * {@link PlayerSession}s associated with this game room.
     *
     * @param game       The instance of the game for which the game room needs to be
     *                   removed.
     * @param gameRoomId The unique identifier for the game room. Most probably a
     *                   database id.
     * @return Optionally returns an object, if it is an asynchronous operation,
     ...
     * @param game         The instance of the game for which the game room needs to be
     *                     removed
     * @param gameRoomName The name of the game room to unload.
     * @return Optionally returns an object, if it is an asynchronous operation,
     * then it would return a Future object, otherwise it would return a
     * boolean suggesting success(true) or failure(false).
     */
