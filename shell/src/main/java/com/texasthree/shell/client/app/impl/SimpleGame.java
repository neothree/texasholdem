...
import com.texasthree.shell.client.app.Game;
...
public class SimpleGame implements Game {
     ...
     * Meant as a database access key.
     *
     * @param id Set the unique identifier for this game.
     */
    @Override
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        com.texasthree.shell.client.app.impl.SimpleGame other = (com.texasthree.shell.client.app.impl.SimpleGame) obj;
        if (gameName == null) {
