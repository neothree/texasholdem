...
public interface ReconnectPolicy {
    ...
    public static class ReconnectNTimes implements com.texasthree.shell.client.communication.ReconnectPolicy {
         ...
         *
         * @param times       The number of times session reconnect should be attempted.
         * @param delay       The delay between reconnect attempts in milliseconds. For
         *                    e.g 5000 = 5 seconds delay.
         * @param loginHelper Used to pass configuration information to setup the
