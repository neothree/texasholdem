package com.texasthree.shell.client.app;
...
public interface Player {
     ...
     *
     * @param name Set the string name, strings more than 100 characters long may
     *             be rejected.
     */
     ...
     *
     * @param emailId Sets the email id string. strings more than 50 characters long
     *                may be rejected.
     */
     ...
     *
     * @param playerSession The session which is to be logged out.
     */
