...
public interface DeliveryGuaranty {
    /**
     * An enumeration which implements {@link com.texasthree.shell.client.communication.DeliveryGuaranty}. Used to
     * abstract out the TCP and UDP transports.
     *
     * @author Abraham Menacherry
     */
    public enum DeliveryGuarantyOptions implements com.texasthree.shell.client.communication.DeliveryGuaranty {
        RELIABLE(1), FAST(2);
        final int guaranty;
