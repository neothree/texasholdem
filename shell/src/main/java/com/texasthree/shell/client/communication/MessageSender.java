...
public interface MessageSender {
    ...
    public interface Reliable extends com.texasthree.shell.client.communication.MessageSender {
    }

    public interface Fast extends com.texasthree.shell.client.communication.MessageSender {
    }
}
