package com.texasthree.shell.client.communication;

import com.texasthree.shell.client.convert.Transform;
...
public interface MessageBuffer<T> {
     ...
     * @throws IndexOutOfBoundsException if isReadable() returns false.
     */
    int readByte();
     ...
     *
     * @param converter The converter which will transform the bytes to relevant
     *                  object.
    ...
    com.texasthree.shell.client.communication.MessageBuffer<T> writeByte(byte b);
     ...
     */
    com.texasthree.shell.client.communication.MessageBuffer<T> writeBytes(byte[] src);
     ...
     */
    com.texasthree.shell.client.communication.MessageBuffer<T> writeShort(int value);
     ...
     */
    com.texasthree.shell.client.communication.MessageBuffer<T> writeMedium(int value);
     ...
     */
    com.texasthree.shell.client.communication.MessageBuffer<T> writeInt(int value);
     ...
     */
    com.texasthree.shell.client.communication.MessageBuffer<T> writeLong(long value);
     ...
     * @throws IndexOutOfBoundsException if {@code this.writableBytes} is less than {@code 2}
     */
    com.texasthree.shell.client.communication.MessageBuffer<T> writeChar(int value);
     ...
     * @throws IndexOutOfBoundsException if {@code this.writableBytes} is less than {@code 4}
     */
    com.texasthree.shell.client.communication.MessageBuffer<T> writeFloat(float value);
     ...
     * @throws IndexOutOfBoundsException if {@code this.writableBytes} is less than {@code 8}
     */
    com.texasthree.shell.client.communication.MessageBuffer<T> writeDouble(double value);

    com.texasthree.shell.client.communication.MessageBuffer<T> writeString(String message);

    com.texasthree.shell.client.communication.MessageBuffer<T> writeStrings(String... message);
     ...
     *
     * @param converter For most implementations, the converter which will transform
     *                  the object to byte array.
     * @param <V>       The object to be converted, mostly to a byte array or relevant
     *                  buffer implementation.
     * @return Instance of this class itself.
     */
    <V> com.texasthree.shell.client.communication.MessageBuffer<T> writeObject(Transform<V, T> converter, V object);
