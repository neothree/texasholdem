...
public class DefaultSession implements Session {
     ...
     * by the {@link com.texasthree.shell.client.app.impl.DefaultSession} constructor for ease of use. May not be good
     * design though.
     *
     * @author Abraham, Menacherry
     */
    public static class SessionBuilder {
        ...
        public Session build() {
            return new com.texasthree.shell.client.app.impl.DefaultSession(this);
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        com.texasthree.shell.client.app.impl.DefaultSession other = (com.texasthree.shell.client.app.impl.DefaultSession) obj;
        if (id == null) {
            if (other.id != null)
                return false;
