...
public class NettyTCPClient {
    ...
    /**
     * Creates a new instance of the {@link com.texasthree.shell.client.NettyTCPClient}. This constructor
     ...
     * @param boss                {@link EventLoopGroup} used for client.
     * @param maxShutdownWaitTime The amount of time in seconds to wait for this client to close
    ...
    public NettyTCPClient(final InetSocketAddress serverAddress,
        ...
        Runtime.getRuntime().addShutdownHook(new Thread() {
            public void run() {
                ...
                try {
                    future.await(com.texasthree.shell.client.NettyTCPClient.this.maxShutdownWaitTime);
     ...
     * delegated method.
     *
     * @param pipelineFactory The factory used to create a pipeline of decoders and encoders
     *                        for each {@link Channel} that it creates on connection.
     * @param loginEvent      The event contains the {@link ByteBuf} to be transmitted
     ...
     *                        username, password, connection key, <b>optional</b> local
     *                        address of the UDP channel used by this session.
     * @param timeout         The amount of time to wait for this connection be created
     *                        successfully.
     * @param unit            The unit of timeout SECONDS, MILLISECONDS etc. Default is 5
     *                        seconds.
     * @return Returns the Netty {@link Channel} which is the connection to the
     * remote nadron server.
     * @throws InterruptedException
