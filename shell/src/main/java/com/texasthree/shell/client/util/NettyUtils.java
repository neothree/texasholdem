...
public class NettyUtils {
     ...
     * written.
     *
     * @param buffer       The buffer containing the strings, with each string being a
     *                     strlength-strbytes combination.
     * @param numOfStrings The number of strings to be read. Should not be negative or 0
     ...
     *                     strlength-strbytes combination.
     * @param numOfStrings The number of strings to be read. Should not be negative or 0
     * @param charset      The Charset say 'UTF-8' in which the decoding needs to be
     *                     done.
     * @return the strings read from the buffer as an array.
     */
    public static String[] readStrings(ByteBuf buffer, int numOfStrings,
     ...
     *
     * @param buffer The Netty buffer containing at least one unsigned short
     ...
     * UTF-8 binary>
     *
     * @param charset The Charset say 'UTF-8' in which the encoding needs to be
     *                done.
     * @param msgs    The messages to be written.
     * @return {@link ByteBuf} with format
     * length-stringbinary-length-stringbinary
     ...
     * + actual length.
     *
     * @param buffer The Netty buffer containing the Object.
    ...
    public static InetSocketAddress readSocketAddress(ByteBuf buffer)
            throws Exception {
        String remoteHost = com.texasthree.shell.client.util.NettyUtils.readString(buffer);
        int remotePort = 0;
