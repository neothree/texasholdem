...
import com.texasthree.shell.client.communication.NettyTCPMessageSender;
import com.texasthree.shell.client.communication.NettyUDPMessageSender;
...
import com.texasthree.shell.client.handlers.netty.TCPPipelineFactory;
import com.texasthree.shell.client.handlers.netty.UDPPipelineFactory;
...
public class SessionFactory {
     ...
     * lost on connect.
     *
     * @param eventHandlers The handlers to be added to listen to session.
     * @return The session instance created and connected to remote nadron server.
     * @throws InterruptedException
     * @throws Exception
     */
     ...
     * transports.
     *
     * @param session The session to be connected to remote nadron server.
     * @throws InterruptedException
     * @throws Exception
     */
     ...
     *
     * @param session       The session to be connected to remote nadron server.
     * @param eventHandlers The handlers to be added to session.
     * @throws InterruptedException
     * @throws Exception
     */
     ...
     * server.
     *
     * @param session      The session which needs to be re-connected.
     * @param reconnectKey This is provided by the server on
     ...
     *
     * @param session The final handler in the protocol chain needs the session so
