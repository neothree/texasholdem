...
import com.texasthree.shell.client.communication.DeliveryGuaranty.DeliveryGuarantyOptions;
...
import com.texasthree.shell.client.event.impl.ChangeAttributeEvent;
import com.texasthree.shell.client.event.impl.DefaultEvent;
import com.texasthree.shell.client.event.impl.DefaultNetworkEvent;
...
public class Events {
    ...
    public static NetworkEvent networkEvent(Object source, DeliveryGuaranty deliveryGuaranty) {
        Event event = event(source, com.texasthree.shell.client.event.Events.NETWORK_MESSAGE);
