package com.texasthree.shell.client;
...
import com.texasthree.shell.client.handlers.netty.UDPUpstreamHandler;
...
public class NettyUDPClient {
     ...
     *
     * @param nadronHost      The host name of the remote server on which nadron server is
     *                        running.
     * @param port            The port to connect to, on the remote server.
     * @param pipelineFactory The pipeline factory to be used while creating a Netty
     *                        {@link Channel}
    ...
    /**
     * Creates a new instance of the {@link com.texasthree.shell.client.NettyUDPClient}. It actually
     * delegates to
     ...
     *
     * @param serverAddress   The remote servers address. This address will be used when any
     *                        of the default write/connect methods are used.
     * @param pipelineFactory The Netty factory used for creating a pipeline. For UDP, this
     ...
     * @param localhostName   Name of the host to which this client is to be bound.
    ...
    /**
     * Creates a new instance of the {@link com.texasthree.shell.client.NettyUDPClient}.
     *
     * @param serverAddress   The remote servers address. This address will be used when any
     *                        of the default write/connect methods are used.
     * @param pipelineFactory The Netty factory used for creating a pipeline. For UDP, this
     ...
     *
     * @param session         The session for which the datagram channel is being created.
     * @param datagramChannel The channel on which the message is to be sent to remote
     *                        server.
     ...
     *
     * @param localhostName The host machine (for e.g. 'localhost') to which it needs to
     ...
     * @param datagramChannel The channel on which the message is to be sent to remote
     *                        server.
     * @param serverAddress   The remote address of the server to which to connect.
     * @param timeout         Amount of time to wait for the connection to happen.
     ...
     * @param datagramChannel The channel on which the message is to be sent to remote
     *                        server.
     * @param message         The message to be sent. <b>NOTE</b> The message should be a
