...
class RoomProtocalTest {
    ...
    void testRoomData() throws Exception {
        ...
        var data = new RoomProtocal.RoomData(room, user.getId());
    ...
    void assertBuyin(RoomProtocal.Buyin buyin, int sum, int profit, String name) {
