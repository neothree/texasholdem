package com.texasthree.appzone.protocal;
...
import com.texasthree.appzone.round.TexasInsurance;
import com.texasthree.appzone.round.TexasRound;
...
public class RoomProtocal {
    ...
    public static class RoomLabel {
        ...
        public RoomLabel(Room v) {
            ...
            this.occupied = (int) v.getSeats().stream().filter(com.texasthree.appzone.room.Seat::occupied).count();
        }
    }
    ...
    public static class RoomData {
        ...
        public RoomData(Room room, String uid) {
            ...
            this.seats = room.getSeats().stream()
                    .filter(com.texasthree.appzone.room.Seat::occupied)
    ...
    public static class User {
        ...
        public User(com.texasthree.appzone.User user, Room room) {
            this.uid = user.getId();
    ...
    public static class Seat {
        ...
        public Seat(com.texasthree.appzone.room.Seat s, Room room) {
            this.seatId = s.id;
            if (s.occupied()) {
